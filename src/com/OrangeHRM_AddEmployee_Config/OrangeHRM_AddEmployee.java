package com.OrangeHRM_AddEmployee_Config;
...
public class OrangeHRM_AddEmployee extends Base_AddEmployee
{
	...
	String expectedaddemppagetext="Full Name";

	String expectedpersonaldetailspagetext="Full Name";

	String expectedlogoutloginpagetext="LOGIN Panel";

	

	String expectedFirstName1="Srini01";

	String expectedFirstName2="Ram02";

	String expectedFirstName3="Raj03";

	

	String expectedmiddleName1="Hello01";

	String expectedmiddleName2="HEllo02";

	String expectedmiddleName3="Hello03";

	

	String expectedlastName1="Chello01";

	String expectedlastName2="Chello02";

	String expectedlastName3="Chello03";
	...
	@Test(priority=1,description="Login Page Image Validation")
	public void imageValidation()
	{
		...
		By loginpageimageProperty=By.xpath("/html/body/div[1]/div/div[2]/div/img");
		...
		{
			System.out.println("login page image is not displayed");
		}
	}

	@Test(priority=2,description="Filling excel sheet with expected Values")
	public void excel_filling() throws IOException

	{

	inputdata=new FileInputStream("./configurationProperties/AddEmployeeConfigProperties");
	...
	FileInputStream inputtestdata= new FileInputStream("./ExcelSheets/ORANGEHRM_ADD_Employeee.xlsx");
	...
	FileOutputStream outputdata=new FileOutputStream("./ExcelSheets/ORANGEHRM_ADD_Employeee.xlsx");
	...
	@Test(priority=4,description="Validation of Login Page Title Of the Application & filling the excel with result")
	...
	@Test(priority=5,description="Getting actual home page text of the application and filling in the Excel")
	...
	@Test(priority=6,description="validation of login page text of the application and filling in the Excel")
	...
	@Test(priority=7,description="validation of home page text of the application and filling Excel with home page test result")
	...
	@Test(priority=8,description="getting actual add employee page text of the application and filling Excel")
	...
	By fullnameProperty=By.className(propertiesFile.getProperty("fullnameClassNameProperty"));

	WebElement fullnameElement=driver.findElement(fullnameProperty);

	String actAddEmpPageText=fullnameElement.getText();
	...
	@Test(priority=9,description="Validation of add employee page text of the application and filling add employee text test result in Excel")
	...
	@Test(priority=10,description="Filling add employee in the application and saving it")
	...
	By actfullnameProperty=By.className(propertiesFile.getProperty("ActualfullnameclassnameProperty"));

	WebElement actfullnameElement=driver.findElement(actfullnameProperty);

	String actualpageFullNameTExt=actfullnameElement.getText();

	sheetofworkbook.getRow(index).createCell(20).setCellValue(actualpageFullNameTExt);
	...
	By actempidProperty=By.className(propertiesFile.getProperty("EmployeeIDclassnameProperty"));

	WebElement actempidElement=driver.findElement(actempidProperty);

	String actEmpIdValue=actempidElement.getAttribute(propertiesFile.getProperty("ActualempidgetattributeValue"));
	...
	@Test(priority=11,description="OrangeHRM Application getting logging out")
	...
	@Test(priority=12,description="Validations for all data")
	...
	@Test(priority=13,description="Capturing Actual login page text and validation of login page text")
	...
	@Test(priority=14,description="Validation of login page text and filling login pgae text result in the Excel")
